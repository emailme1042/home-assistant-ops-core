...
# run YAML validator and write fix sheet
python3 /config/scripts/validate_yaml.py > /config/fix_sheet.yaml 2>> /config/fix_errors.log; echo "$(Get-Date) - YAML validation complete." >> /config/fix_sheet.yaml
```
