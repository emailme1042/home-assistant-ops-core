# Team Tasks - November 14, 2025 v2
...
- [ ] Resolve HA interface crashes and Browser Mod issues
- [ ] Fix 6,038 unavailable entities
- [ ] Enable functional Nabu Casa remote access
- [ ] Complete MQTT supervisor connection resolution
- [ ] Achieve stable HA operation (<1 crash/week)
...
#### Blockers
- Directory access issues (most folders show "file not available")
- MQTT supervisor authentication failure
- Nabu Casa application layer stuck in reconnect loop
...
- [x] Organize loose files into appropriate folders - COMPLETED: Created docs/, archive/, tests/, resources/ folders and moved 25+ files
