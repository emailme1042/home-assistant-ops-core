...
**📋 Detailed Operating Rules**: See `AI_WORKSPACE/SHARED_CONTEXT/SESSION_ESSENTIALS/AGENT_ROLES.md` for comprehensive GPT operating procedures and restrictions.
...
## � Deployment Plan — Making Files Accessible
...
⚙️ **GitHub Copilot**: You will create this dashboard file next.
